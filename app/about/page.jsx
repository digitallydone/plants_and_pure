            ...
            <div className="flex flex-col items-center gap-10 md:flex-row">
              ...
              <div className="md:w-1/2">
                <div className="relative">
                  <div className="absolute z-0 w-24 h-24 bg-green-100 rounded-full -left-6 -top-6"></div>
                  <div className="absolute z-0 w-24 h-24 rounded-full -bottom-6 -right-6 bg-amber-100"></div>
                  <img
          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
              <div className="p-6 bg-white rounded-lg shadow-md">
                ...
                <h3 className="mb-4 font-serif text-xl text-center text-gray-800">
                  Quality
                </h3>
